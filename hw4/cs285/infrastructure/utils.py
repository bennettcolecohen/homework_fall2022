...
# COPIED FUNCTIONS FROM HW3 SOLUTIONS
...
#         new_trajectory = sample_trajectory(env, policy, max_path_length, render = False)
#         paths.append(new_trajectory)
#         timesteps_this_batch += get_pathlength(new_trajectory)
